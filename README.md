...
A friend asked me the other day how to build an AI development pipeline that would make his team faster. So I told him about the setup I use to run coding agents. A ticket goes in one end and a reviewed PR comes out the other, and I am not in the middle. He wanted to know how to build it.
